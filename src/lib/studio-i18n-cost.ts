...
const en: Messages = {
  "studio.cost.estimatedValue": "Approx. credit value {amount}",
  "studio.cost.afterGeneration": "After this: {credits} credits · about {count} more",
  "studio.cost.valueDisclaimer": "Estimate based on Studio Pack; pack rates vary. No extra charge.",
...
export const studioCostMessages: Record<Locale, Messages> = {
  en,
  "zh-CN": {
    "studio.cost.estimatedValue": "积分价值约 {amount}",
    "studio.cost.afterGeneration": "生成后剩余 {credits} 积分 · 约还能生成 {count} 次",
    "studio.cost.valueDisclaimer": "按 Studio Pack 估算，各积分包单价不同，不会额外扣款",
  ...
  "zh-TW": {
    "studio.cost.estimatedValue": "點數價值約 {amount}",
    "studio.cost.afterGeneration": "生成後剩餘 {credits} 點 · 約還能生成 {count} 次",
    "studio.cost.valueDisclaimer": "依 Studio Pack 估算，各點數包單價不同，不會額外收費",
  ...
  "pt-BR": {
    "studio.cost.estimatedValue": "Valor aproximado dos créditos: {amount}",
    "studio.cost.afterGeneration": "Depois: {credits} créditos · cerca de mais {count}",
    "studio.cost.valueDisclaimer": "Estimativa pelo Studio Pack; valores variam por pacote. Sem cobrança extra.",
  ...
  ru: {
    "studio.cost.estimatedValue": "Примерная стоимость кредитов: {amount}",
    "studio.cost.afterGeneration": "Останется {credits} кредитов · ещё около {count} генераций",
    "studio.cost.valueDisclaimer": "Расчёт по Studio Pack; цена зависит от пакета. Без доплаты.",
  ...
  vi: {
    "studio.cost.estimatedValue": "Giá trị credit ước tính {amount}",
    "studio.cost.afterGeneration": "Còn {credits} tín dụng · khoảng {count} lượt nữa",
    "studio.cost.valueDisclaimer": "Ước tính theo Studio Pack; đơn giá tùy gói. Không tính thêm phí.",
  ...
  de: {
    "studio.cost.estimatedValue": "Geschätzter Credit-Wert {amount}",
    "studio.cost.afterGeneration": "Danach: {credits} Credits · etwa {count} weitere",
    "studio.cost.valueDisclaimer": "Schätzung anhand des Studio Pack; Paketpreise variieren. Keine Zusatzkosten.",
  ...
  fr: {
    "studio.cost.estimatedValue": "Valeur estimée des crédits {amount}",
    "studio.cost.afterGeneration": "Après : {credits} crédits · environ {count} de plus",
    "studio.cost.valueDisclaimer": "Estimation selon le Studio Pack ; tarifs variables selon le pack. Sans frais supplémentaires.",
  ...
  ja: {
    "studio.cost.estimatedValue": "クレジット換算 約{amount}",
    "studio.cost.afterGeneration": "生成後 {credits} クレジット · あと約 {count} 回",
    "studio.cost.valueDisclaimer": "Studio Packを基準にした目安です。パックごとに単価が異なり、追加請求はありません。",
  ...
  th: {
    "studio.cost.estimatedValue": "มูลค่าเครดิตโดยประมาณ {amount}",
    "studio.cost.afterGeneration": "หลังสร้างเหลือ {credits} เครดิต · อีกประมาณ {count} ครั้ง",
    "studio.cost.valueDisclaimer": "ประเมินจาก Studio Pack ราคาต่อเครดิตต่างกันตามแพ็ก ไม่มีค่าใช้จ่ายเพิ่ม",
  ...
  nl: {
    "studio.cost.estimatedValue": "Geschatte creditwaarde {amount}",
    "studio.cost.afterGeneration": "Daarna: {credits} credits · nog circa {count}",
    "studio.cost.valueDisclaimer": "Schatting op basis van Studio Pack; tarieven verschillen per pakket. Geen extra kosten.",
  ...
  he: {
    "studio.cost.estimatedValue": "ערך קרדיטים משוער {amount}",
    "studio.cost.afterGeneration": "לאחר מכן: {credits} קרדיטים · עוד כ־{count}",
    "studio.cost.valueDisclaimer": "הערכה לפי Studio Pack; המחיר משתנה בין חבילות. ללא חיוב נוסף.",
  ...
  ko: {
    "studio.cost.estimatedValue": "크레딧 환산 가치 약 {amount}",
    "studio.cost.afterGeneration": "생성 후 {credits} 크레딧 · 약 {count}회 더 가능",
    "studio.cost.valueDisclaimer": "Studio Pack 기준 예상치이며 팩마다 단가가 다릅니다. 추가 결제는 없습니다.",
  ...
  es: {
    "studio.cost.estimatedValue": "Valor estimado de créditos {amount}",
    "studio.cost.afterGeneration": "Después: {credits} créditos · unas {count} más",
    "studio.cost.valueDisclaimer": "Estimación basada en Studio Pack; las tarifas varían por paquete. Sin cargo adicional.",
  ...
  it: {
    "studio.cost.estimatedValue": "Valore stimato dei crediti {amount}",
    "studio.cost.afterGeneration": "Dopo: {credits} crediti · circa altre {count}",
    "studio.cost.valueDisclaimer": "Stima basata su Studio Pack; le tariffe variano per pacchetto. Nessun addebito extra.",
  ...
  ar: {
    "studio.cost.estimatedValue": "قيمة الرصيد التقديرية {amount}",
    "studio.cost.afterGeneration": "بعدها: {credits} رصيد · نحو {count} مرات أخرى",
    "studio.cost.valueDisclaimer": "تقدير حسب Studio Pack؛ تختلف الأسعار بين الباقات. بلا رسوم إضافية.",
